...
const Index = () => {
  ...
  return <div className={`min-h-screen ${getDeviceSpecificClasses()}`}>
      <CosmicBackground />
      <div className={`container max-w-4xl mx-auto px-4 py-8 relative z-10`}>
        <header className="text-center mb-10">
          ...
          <p className="text-muted-foreground max-w-lg mx-auto">
            Discover what the stars have to say today with <span className="text-primary font-medium">Herbscope</span>. 
            Select your zodiac sign to reveal cannabis strains that align with your personal horoscope.
          </p>
        </header>
        ...
        <footer className={`mt-16 text-center text-xs text-muted-foreground ${isIOS ? 'mb-6' : isAndroid ? 'mb-4' : ''}`}>
          ...
          <p className="mt-1">© {new Date().getFullYear()} Cosmic Cannabis Guide | <span className="text-primary">Herbscope</span></p>
        </footer>
      </div>
    </div>;
};
